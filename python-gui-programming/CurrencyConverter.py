...
class Form(QDialog):
    ...
    def get_data(self, parent=None):
        self.rates= {}

        try:
            date = "Unknown"

            fh = urllib.urlopen("http://www.collectionscanada.gc.ca/eppp-archive/100/201/301/bank_can_review/2006/spring/cover/en/markets/csv/exchange_eng.csv")
